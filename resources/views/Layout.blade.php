...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!-- <li class="nav-item has-treeview main_active ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item main_active ">
                  <a href="{{url('Admin/create-tax')}}" class="nav-link">
                  <i class="nav-icon fas fa-file-invoice"></i>
                    <p>Create Tax</p>
                  </a>
                </li>
                <li class="nav-item main_active ">
                  <a href="{{url('Admin/create-invoice')}}" class="nav-link">
                  <i class="nav-icon fas fa-file-invoice"></i>
                    <p>Create Invoice</p>
                  </a>
                </li>
                ...
                <li class="nav-item main_active ">
                  <a href="{{url('Admin/view-invoice')}}" class="nav-link">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; <?=date("Y")?> </strong> All rights reserved. Developed By 
    </footer>
  </div>
  <!-- ./wrapper -->
  <script>

  ...
  <div class="col-lg-12 col-md-12">
    <div class="card card-secondary">
      <div class="card-header border-transparent">
        ...
        <a href="{{route('Dashboard')}}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Back</a> 
        ...
        <div class="form-row">       
          ...
          <div class="form-group p-3" style="margin-left:31rem;">
					...
					<div class="imgcontainer">
                            ...
                            <img src="{{asset('public/img/'.$user->picture)}}" id="ProfileDisplay" alt="Avatar" class="avatar">
                            </label>
							</div>
                    </div>
          ...
          <div class="form-row">  
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="email" class="form-control" id="phone" name="user_mobile" value="{{$user->phone}}">
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleInputEmail1">Country</label>
                    <input type="email" class="form-control" id="country" name="country" value="{{$user->country}}">
                </div>
            </div>
        <div class="form-row"> 
            <div class="form-group col-md-6">
                <label for="exampleInputEmail1">state</label>
                <input type="email" class="form-control" id="state" name="state" value="{{$user->state}}">
            </div>
            <div class="form-group col-md-6">
                <label for="exampleInputEmail1">City</label>
                <input type="email" class="form-control" id="city" name="city" value="{{$user->city}}">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" id="user_password" name="user_password" class="form-control" value="{{$user->password}}">
            </div>
        </div>    
        </form>

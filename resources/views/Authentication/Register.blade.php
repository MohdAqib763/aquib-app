...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  <a class="navbar-brand" href="#">Aexonic Technologies Test</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link text-white" href="{{url('/')}}">Register <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
			...
			@csrf
                ...
                <div class="form-row">
					...
					<div class="imgcontainer">
                            ...
                            <img src="{{asset('public/images/user.png')}}" id="ProfileDisplay" alt="Avatar" class="avatar">
                            </label>
							</div>
                    </div>
                </div>

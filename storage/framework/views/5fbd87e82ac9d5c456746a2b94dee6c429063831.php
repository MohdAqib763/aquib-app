    ...
    <div class="card card-primary">
      <div class="card-header border-transparent">
        ...
        <div class="card-tools">
          ...
          <a href="<?php echo e(route('Dashboard')); ?>" class="btn btn-tool">
      ...
      <div class="card-body">
        ...
        <form id="ProfileForm" enctype="multipart/form-data">
          ...
          <input type="hidden" name="user_id" id="user_id" value="<?php echo e(Session::get('role_id')); ?>">
          <div class="form-group">
            <label for="exampleInputEmail1">Name</label>
            <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo e($users->admin_name); ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Email</label>
            <input type="email" class="form-control" id="user_email" name="user_email" value="<?php echo e($users->admin_email); ?>">
          </div>
          <div class="form-group">
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\testProject\resources\views/Users/UserProfile.blade.php ENDPATH**/ ?>
...
<span style="font-size:14px; color:#484848;">(Under Rule 31 Of CGST/MGST Act 2017)</span></td>
    ...
    <tr>
      <td colspan="2" align="left" valign="middle" style="padding:10px 5px;"><table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid 1px #ddd;">
        ...
        <tr>
          ...
          <td align="center" valign="middle"><?php echo e($product->percentage); ?> %</td>
          <td align="center" valign="middle"><?php if( $product->discount != ""){
              echo $Disprice; 
            }else{ echo $product->amount; } ?></td>
          <td align="center" valign="middle"><?php echo e($product->percentage); ?> %</td>
    ...
    <tr>
      <td align="left" valign="top" style="padding-left:5px; padding-top:7px; padding-bottom:7px; border-bottom:solid 1px #ddd; border-top:solid 1px #ddd; border-right:solid 1px #ddd; ">Company's PAN<strong> : AAEFD9948G<br />
        <br />
       <br />
...
</html><?php /**PATH C:\xampp\htdocs\Kailash\resources\views/Admin/invoicepdf.blade.php ENDPATH**/ ?>
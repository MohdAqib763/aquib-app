...
function InvoiceDelete(id){
  ...
  if(verify == true){
    ...
    $.post("<?php echo e(url('invoice-delete')); ?>",{id:id},
    function(data){
     console.log(data);
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kailash\resources\views/Admin/InvoiceList.blade.php ENDPATH**/ ?>
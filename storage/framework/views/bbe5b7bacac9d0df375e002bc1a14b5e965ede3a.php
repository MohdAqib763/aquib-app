            ...
            <ul class="nav nav-pills flex-column">
              <li class="nav-item active">
                <a href="#" class="nav-link">
                  ...
                  <span class="badge bg-primary float-right"><?php echo e($emails_unread); ?></span>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
              ...
              <div class="form-group">
                <select class="form-control" name="email_to" id="email_to">
                  ...
                  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($user->admin_id); ?>"><?php echo e($user->admin_name); ?></option>
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\testProject\resources\views/Users/MessageCompose.blade.php ENDPATH**/ ?>
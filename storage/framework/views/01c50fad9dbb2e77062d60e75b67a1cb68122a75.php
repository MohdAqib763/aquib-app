      ...
      <div class="card-body register-card-body">
        ...
        <form id="RegisterForm">
          ...
          <div class="input-group mb-3">
            <input type="text" id="admin_name" name="admin_name" class="form-control" placeholder="Full name">
          ...
          <div class="input-group mb-3">
          <input type="text" name="admin_mobile" id="admin_mobile" class="form-control" placeholder="Mobile" maxlength="10" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-envelope"></span>
              </div>
        ...
        <div class="row">
          <div class="col-6">
            <button type="button" id="BtnSubmit" onclick="AdminStore()" class="btn btn-primary text-white btn-block">Register</button>
          </div>
          <div class="col-6">
...
</html><?php /**PATH C:\xampp\htdocs\testProject\resources\views/Admin/AdminRegister.blade.php ENDPATH**/ ?>
				...
				<div class="form-row">
					...
					<h3>Bill To Party</h3>
						...
						<div class="form-group col-md-6">
							...
							<textarea type="text" class="form-control" id="address" name="address" ><?php echo e($bParty->address); ?></textarea>
						</div>
						<div class="form-group col-md-6">
					...
					<h3>Ship To Party</h3>
						...
						<div class="form-group col-md-6">
							<label for="inputPassword4">Address</label>
							<textarea type="text" class="form-control" id="ship_address" name="ship_address" ><?php echo e($sParty->address); ?></textarea>
						</div>
						<div class="form-group col-md-6">
							<label for="inputPassword4">GSTIN</label>
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kalash\resources\views/Admin/Edit-invoice.blade.php ENDPATH**/ ?>
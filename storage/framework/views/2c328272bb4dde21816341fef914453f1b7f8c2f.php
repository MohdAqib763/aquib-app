...
$(function() {
  ...
  var table = $("#table_id").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "<?php echo e(route('Message-Inbox-Show')); ?>",
      // data: {
      //   from_date: from_date,
      //   to_date: to_date
      // }
...
function MessageRead(user_id,email_id) {
    ...
    var base_url = "<?php echo e(url('Message-Read')); ?>";
...
function InboxMessageRemove(email_id) {
  ...
  if(verify == true){
    ...
    $.post("<?php echo e(route('Message-Inbox-Remove')); ?>",{email_id:email_id},
    function(data){
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\testProject\resources\views/Users/MessageInbox.blade.php ENDPATH**/ ?>
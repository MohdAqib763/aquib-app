...
<div class="card card-default">
		...
		<form id="QuoteForm">
		<?php echo csrf_field(); ?>
        <input type="hidde" name="quote_id" value="<?php echo e($row->quote_id); ?>">
		   <div class="form-row">
		   		<div class="col-md-6">
             ...
             <h3>Customer Details</h3>
				...
				<div class="row">
						...
						<div class="form-group col-md-12">
							<textarea id="terms" name="terms" rows="4" cols="70"><?php echo e($row->terms_condition); ?></textarea>
						</div>
						</div>
				<h3>Add Items:</h3>
          	<table class="table">
...
<?php echo $__env->make('Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kalash\resources\views/Admin/Edit-quote.blade.php ENDPATH**/ ?>